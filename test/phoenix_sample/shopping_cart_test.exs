defmodule PhoenixSample.ShoppingCartTest do
  ...
  describe "carts" do
    ...
    import PhoenixSample.ShoppingCartFixtures
    ...
    test "create_cart/1 with valid data creates a cart" do
      ...
      assert cart.user_email == "some user_email"
    end
    ...
    test "update_cart/2 with valid data updates the cart" do
      ...
      assert cart.user_email == "some updated user_email"
    end
  ...
  describe "cart_items" do
    alias PhoenixSample.ShoppingCart.CartItem
