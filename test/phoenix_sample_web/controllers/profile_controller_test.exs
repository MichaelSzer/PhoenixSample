defmodule PhoenixSampleWeb.ProfileControllerTest do
  use PhoenixSampleWeb.ConnCase

  import PhoenixSample.ManagerFixtures

  @create_attrs %{handle_name: "some handle_name", social_media: "some social_media", tags: "some tags"}
  ...
  describe "update profile" do
    ...
    test "redirects when data is valid", %{conn: conn, profile: profile} do
      ...
      assert html_response(conn, 200) =~ "some updated handle_name"
    end
