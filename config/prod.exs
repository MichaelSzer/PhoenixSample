...
config :phoenix_sample, PhoenixSampleWeb.Endpoint, cache_static_manifest: "priv/static/cache_manifest.json"
...
# Gigalixir Configuration - https://gigalixir.readthedocs.io/en/latest/modify-app/distillery.html#configuration-and-secrets
config :phoenix_sample, PhoenixSampleWeb.Endpoint,
